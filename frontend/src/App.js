...
import './App.css'; // Ensure you import the CSS file for additional styles if needed
  ...
  return (
    <div className=' bg-black'>
      <div className="relative h-screen w-screen ">
        ...
        {/* Gradient overlay starting halfway down */}
        <div className="absolute top-2/3 left-0 h-1/3 w-full bg-gradient-to-b from-transparent to-black"></div>

        {/* Text on the bottom right */}

        <img className="absolute top-0 m-2 mt-8 w-28 h-28" src="initial.png" />
      ...
      <h1 className="p-8 text-white text-3xl font-extrabold">Links:</h1>
      ...
      <div className="grid grid-cols-2 gap-4 pr-8 pl-8 pb-20">
        <a href="https://www.instagram.com/gauthampdn" target="_blank" rel="noopener noreferrer" className="w-full border-2 rounded-3xl p-2">
          <div className="w-full h-50 bg-black rounded-3xl shadow-lg hover:shadow-2xl transition-shadow flex items-center justify-center">
            <img
              src="/insta.png"
              alt="Instagram"
